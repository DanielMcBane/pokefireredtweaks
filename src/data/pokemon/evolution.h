const struct Evolution gEvolutionTable[NUM_SPECIES][EVOS_PER_MON] =
{
    ...
    [SPECIES_VULPIX]     = {{EVO_ITEM, ITEM_MOON_STONE, SPECIES_NINETALES},
    ...
    [SPECIES_GRIMER]     = {{EVO_LEVEL, 32, SPECIES_MUK}},
    ...
    [SPECIES_MAGIKARP]   = {{EVO_LEVEL, 30, SPECIES_GYARADOS}},
    ...
    [SPECIES_PICHU]      = {{EVO_LEVEL, 12, SPECIES_PIKACHU}},
